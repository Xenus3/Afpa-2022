...
onmousemove = function(e){
        ...
        document.getElementById("horizentale").innerHTML = `Position horizentale (X): ${e.clientX}`;//on affiche lo position horizentale 
        document.getElementById("verticale").innerHTML = `Position verticale (Y): ${e.clientY}`;//on affiche la position verticale
}