<?php 
$bdd = new PDO('mysql:host=localhost;dbname=vroomissimo', 'root', 'Lens2022!');// on instancie un nouvel objet PDO pour nous connecter a notre base de donneés
...
<body>
  <header>
    <div class="logo">
      <img src="photos/vintage_cars.png">
      <h1>Vroomissimo</h1>
    </div>
